...
const PROGRAM_3 = {
  ...
  gym: {
    ...
    returnLabel: "Первые 3 тренировки в зале после 2 недель паузы: по 2 рабочих подхода, усилие не выше 7/10, без отказа.",
    cardio: {
    ...
    weekLabels: {
      1: "Возвратный блок завершён: по 3 рабочих подхода в основных упражнениях, усилие 7–8/10. Вес растёт только после чистого выполнения.",
